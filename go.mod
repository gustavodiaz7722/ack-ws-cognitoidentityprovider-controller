module github.com/aws-controllers-k8s/cognitoidentityprovider-controller

go 1.25.0

require (
	github.com/aws-controllers-k8s/iam-controller v1.7.3
	github.com/aws-controllers-k8s/kms-controller v1.3.3
	github.com/aws-controllers-k8s/lambda-controller v1.14.1
