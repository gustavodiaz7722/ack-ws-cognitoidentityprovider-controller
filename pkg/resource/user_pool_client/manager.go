...
// +kubebuilder:rbac:groups=cognitoidentityprovider.services.k8s.aws,resources=userpoolclients,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cognitoidentityprovider.services.k8s.aws,resources=userpoolclients/status,verbs=get;update;patch
...
func (rm *resourceManager) ARNFromName(name string) string {
	return fmt.Sprintf(
		"arn:%s:cognitoidentityprovider:%s:%s:%s",
		rm.awsPartition,
		rm.awsRegion,
		rm.awsAccountID,
		name,
