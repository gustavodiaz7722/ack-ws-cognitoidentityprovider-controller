...
const (
	FinalizerString = "finalizers.cognitoidentityprovider.services.k8s.aws/UserPoolClient"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("userpoolclients")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.UserPoolClient{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.UserPoolClient),
	}
}
